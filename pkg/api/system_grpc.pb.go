...
func (c *systemServiceClient) SendFile(ctx context.Context, in *SendFileRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[SendFileResponse], error) {
...
type SystemService_SendFileClient = grpc.ServerStreamingClient[SendFileResponse]
...
func (UnimplementedSystemServiceServer) SendFile(*SendFileRequest, grpc.ServerStreamingServer[SendFileResponse]) error {
...
func _SystemService_SendFile_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(SystemServiceServer).SendFile(m, &grpc.GenericServerStream[SendFileRequest, SendFileResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type SystemService_SendFileServer = grpc.ServerStreamingServer[SendFileResponse]
